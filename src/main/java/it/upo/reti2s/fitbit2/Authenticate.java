...
/*
            LocalServerReceiver receiver = new LocalServerReceiver.Builder().setHost(
                    OAuth2ClientCredentials.DOMAIN).setPort(OAuth2ClientCredentials.PORT).build(); //127.0.0.1:8080*/
        LocalServerReceiver receiver = new LocalServerReceiver.Builder().setHost(
...
*/
    ...
    private static void run(HttpRequestFactory requestFactory) throws IOException {} //pagina accesso
